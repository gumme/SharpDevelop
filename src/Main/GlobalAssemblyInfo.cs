...
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-990068d3")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "9451";
	...
	public const string FullVersion = Major + "." + Minor + "." + Build + ".9451";
}
